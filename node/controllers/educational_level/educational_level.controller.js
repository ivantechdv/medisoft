...
CTRL.create = async (req, res, next) => {
  try {
    Methods.create(req, res, next, EducationalLevel);
  } catch (error) {
...
CTRL.get = async (req, res, next) => {
  try {
    const condition = {};
    Methods.get(req, res, next, EducationalLevel, condition);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
CTRL.getAll = async (req, res, next) => {
  try {
    const condition = {};
    const include = [];
    Methods.getAll(req, res, next, EducationalLevel, condition, include);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
CTRL.getById = async (req, res, next) => {
  try {
    const condition = {};
    Methods.getById(req, res, next, EducationalLevel, condition);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
