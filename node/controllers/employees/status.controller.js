...
CTRL.create = async (req, res, next) => {
  try {
    Methods.create(req, res, next, Status);
  } catch (error) {
...
CTRL.update = async (req, res, next) => {
  try {
    await Methods.update(req, res, next, Status);
  } catch (error) {
    console.log("error", error);
    res.status(500).json({ error: error.message });
  }
...
CTRL.get = async (req, res, next) => {
  try {
    const condition = {};
    Methods.get(req, res, next, Status, condition);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
CTRL.getAll = async (req, res, next) => {
  try {
    ...
    // };
    const include = null;
    Methods.getAll(req, res, next, Status, condition, include);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
CTRL.getById = async (req, res, next) => {
  try {
    const condition = {};
    const include = [];
    Methods.getById(req, res, next, Status, condition, include);
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
