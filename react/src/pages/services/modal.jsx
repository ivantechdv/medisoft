...
const Modal = ({ isOpen, onClose, id, row }) => {
  ...
  const validate = () => {
    ...
    if (formData.position === "") errors.position = "La posición es obligatoria";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!id) {
        response = await postData("services", dataToSend);
        message = "Servicio registrado con éxito";
      } else {
        response = await putData("services/" + id, dataToSend);
        message = "Servicio actualizado con éxito";
      }

      if (response) {
        ToastNotify({ message, position: "top-left", type: "success" });
        onClose("update");
      }
    } catch (error) {
      ...
      >
        ...
        <div className="grid grid-cols-3 mb-6">
          <div className="col-span-2 p-4">
            <h2 className="text-2xl font-bold text-orange-500">Gestión de Servicios</h2>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-center">
            <div className="text-blue-600 text-lg font-semibold">ID Servicio</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                {validationErrors.alias && (
                  <p className="text-red-500 text-sm mt-1">{validationErrors.alias}</p>
                )}
              </div>
              ...
              {/* Descripción */}
              <div className="col-span-2">
                <label className="font-semibold text-blue-600">Descripción</label>
                <textarea
                  id="description"
